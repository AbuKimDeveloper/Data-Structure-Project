...
public class MainObjects {
    void createObjects(){
        ...
        StudentAttempts SportsS = new StudentAttempts();
        ...
        StudentAttempts HistoryS = new StudentAttempts();
        ...
        StudentAttempts TechS = new StudentAttempts();
        ...
        StudentAttempts HealthS = new StudentAttempts();
        ...
        StudentAttempts SocialS = new StudentAttempts();
